      ...
      <div className="grid grid-cols-3 gap-2.5 sm:grid-cols-4">
        {photoUrls.map((url, i) => (
          <button
            ...
            className="group relative aspect-square overflow-hidden rounded-xl bg-zinc-100 transition-transform duration-200 hover:scale-[1.03] hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-500"
          >
            <Image
              src={url}
