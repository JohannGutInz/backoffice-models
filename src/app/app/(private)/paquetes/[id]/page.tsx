...
import { getPaquete, getUsuarioActual, listModelos } from "@/lib/data";
...
export default async function PaqueteDetallePage({
  ...
  const publicUrl = `${process.env.NEXT_PUBLIC_BASE_URL ?? "http://localhost:3000"}/paquetes/${paquete.publicToken}`;
  ...
  return (
    <div>
      ...
      <Card>
        <CardHeader
          title={`Modelos en este paquete (${paquete.models.length})`}
        />
